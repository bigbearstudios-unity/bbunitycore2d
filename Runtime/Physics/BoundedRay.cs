...
namespace BBUnity.Physics2D {
    ...
    public class BoundedRay {
        ...
        public static BoundedRay CreateLeftBoundedRay() {
            return new BoundedRay(Vector2.left);
        }

        public static BoundedRay CreateUpBoundedRay() {
            return new BoundedRay(Vector2.up);
        }

        public static BoundedRay CreateRightBoundedRay() {
            return new BoundedRay(Vector2.right);
        }

        public static BoundedRay CreateDownBoundedRay() {
            return new BoundedRay(Vector2.down);
        }
    }
}